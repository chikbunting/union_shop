...
class ProductService {
  ...
  final List<Product> _products = const [
    Product(
      ...
      price: '£25.00',
      description: 'Our classic Signature Hoodie, comfortable and warm.',
      collection: 'Gifts',
    ...
    Product(
      ...
      title: 'Classic Tee',
      price: '£10.00',
      description: 'Soft cotton classic tee with Union Shop branding.',
      collection: 'Gifts',
    ...
    Product(
      ...
      price: '£15.00',
      description: 'Limited run tee with unique print.',
      collection: 'Gifts',
    ...
    Product(
      ...
      price: '£25.00',
      description: 'Varsity-style hoodie with embroidered logo.',
      collection: 'Gifts',
